...
/// <summary>
/// Event published to request compensation for inventory reservation
/// </summary>
public class CompensateInventoryReservationEvent
{
    public Guid OrderId { get; set; }
    public Guid OrderItemId { get; set; }
    public string BookISBN { get; set; } = string.Empty;
...
/// <summary>
/// Event published to request compensation for seller stats update
/// </summary>
public class CompensateSellerStatsUpdateEvent
{
    public Guid OrderId { get; set; }
    public Guid OrderItemId { get; set; }
    public string SellerId { get; set; } = string.Empty;
