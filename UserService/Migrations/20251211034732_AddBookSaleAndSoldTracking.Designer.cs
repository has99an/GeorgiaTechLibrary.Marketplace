...
namespace UserService.Migrations
{
    ...
    [Migration("20251211034732_AddBookSaleAndSoldTracking")]
    partial class AddBookSaleAndSoldTracking
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("UserService.Domain.Entities.BookSale", b =>
                {
            ...
            modelBuilder.Entity("UserService.Domain.Entities.SellerReview", b =>
                {
                    ...
                    b.HasIndex("OrderId", "SellerId", "CustomerId")
                        .IsUnique()
            ...
            modelBuilder.Entity("UserService.Domain.Entities.BookSale", b =>
                {
                    b.HasOne("UserService.Domain.Entities.SellerBookListing", "Listing")
                        .WithMany()
